...
function tabulate(data::Tuple{RealVector, RealVector}, midpoints::Tuple{Range, Range}, weights::WeightVec)
    xdata, ydata = data
    ndata = length(xdata)
...
function kde(data::Tuple{RealVector, RealVector}, midpoints::Tuple{Range, Range},weights::WeightVec, dist::BivariateDistribution)
...
function kde(data::Tuple{RealVector, RealVector}, dist::BivariateDistribution;
             ...
             npoints::Tuple{Int,Int}=(256,256), weights::WeightVec = default_weights(data))
